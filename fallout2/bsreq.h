...
struct bsreq {
	...
	unsigned				shift; // offset from begin of class or object
	...
	char*					ptr(const void* data) const { return (char*)data + shift; }
	char*					ptr(const void* data, int index) const { return (char*)data + shift + index * size; }
