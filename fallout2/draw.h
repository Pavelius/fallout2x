...
void					textfs(const char* p, int origin, const char*& string_cashe, int& string_origin);
...
bool buttonp(const char* title, unsigned key, fnbutton proc, bool vertical = true);
void buttoncancel();
void buttonok();
void buttonparam();
void cbsetbool();
